<?php
    ...
    //        header("location: index.php");
            ...
            if($r2 = mysqli_fetch_array($q, MYSQLI_ASSOC)){
                ...
                $insert = "insert into reservasAdmin (reserva) values('$idReserva');";
...
<html>
    ...
    <body>
        ...
        ?>
        <div id='voucher'>
                <h1 id='tituloVoucher'>Recibo de reserva</h1>
...
//                    echo "<br/>$cliente->fono<hr>";
                ...
                <?php
                    ...
                    echo "<div id='totalPagar'>Total pagado: $$total [Reservado por $_SESSION[nombre]]</div><hr>";
            ...
            <div id='footVoucher'>
                 <a class='btn' href='menu.php'>Volver</a>
                </div>
        <?php
